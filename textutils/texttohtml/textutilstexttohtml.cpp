...
#include "textutilstexttohtml.h"
#include "textutilsemoticonsparser_p.h"
#include "textutilstexttohtml_p.h"
...
TextUtilsTextToHtmlHelper::TextUtilsTextToHtmlHelper(const QString &plainText, int pos, int maxUrlLen, int maxAddressLen)
    : mText(plainText)
...
QString TextUtilsTextToHtmlHelper::getEmailAddress()
{
    QString address;
...
QString TextUtilsTextToHtmlHelper::getPhoneNumber()
{
...
bool TextUtilsTextToHtmlHelper::atUrl() const
{
...
bool TextUtilsTextToHtmlHelper::isEmptyUrl(const QString &url) const
{
...
QString TextUtilsTextToHtmlHelper::getUrl(bool *badurl)
{
    QString url;
    if (atUrl()) {
...
QString TextUtilsTextToHtmlHelper::highlightedText()
{
...
QString TextUtilsTextToHtml::convertToHtml(const QString &plainText, const TextUtilsTextToHtml::Options &flags, int maxUrlLen, int maxAddressLen)
{
    TextUtilsTextToHtmlHelper helper(plainText, 0, maxUrlLen, maxAddressLen);
    ...
    if (flags & ReplaceSmileys) {
        result = TextUtilsEmoticonsParser::parseEmoticons(result);
    }

    return result;
}

#include "moc_textutilstexttohtml.cpp"
