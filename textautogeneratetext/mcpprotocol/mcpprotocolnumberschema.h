...
{
class TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT McpProtocolNumberSchema
{
public:
...
Q_DECLARE_TYPEINFO(McpProtocol::McpProtocolNumberSchema, Q_RELOCATABLE_TYPE);
TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT QDebug operator<<(QDebug d, const McpProtocol::McpProtocolNumberSchema &t);
