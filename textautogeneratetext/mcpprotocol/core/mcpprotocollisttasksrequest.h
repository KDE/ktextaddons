...
{
class TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT McpProtocolListTasksRequest
{
public:
    /*!
     */
...
TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT QDebug operator<<(QDebug d, const McpProtocol::McpProtocolListTasksRequest &t);
