...
{
class TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT McpProtocolListToolsRequest
{
public:
    /*!
     */
...
TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT QDebug operator<<(QDebug d, const McpProtocol::McpProtocolListToolsRequest &t);
