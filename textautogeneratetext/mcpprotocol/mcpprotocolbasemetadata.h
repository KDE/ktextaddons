...
{
class TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT McpProtocolBaseMetadata
{
public:
    /*!
     */
...
TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT QDebug operator<<(QDebug d, const McpProtocol::McpProtocolBaseMetadata &t);
