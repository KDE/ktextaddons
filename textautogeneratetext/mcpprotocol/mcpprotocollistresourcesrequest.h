...
{
class TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT McpProtocolListResourcesRequest
{
public:
    /*!
     */
...
TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT QDebug operator<<(QDebug d, const McpProtocol::McpProtocolListResourcesRequest &t);
