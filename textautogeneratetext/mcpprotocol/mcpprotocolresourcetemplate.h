...
{
class TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT McpProtocolResourceTemplate
{
public:
    /*!
     */
...
TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT QDebug operator<<(QDebug d, const McpProtocol::McpProtocolResourceTemplate &t);
