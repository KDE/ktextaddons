...
{
class TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT McpProtocolNotificationParams
{
public:
    /*!
     */
...
TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT QDebug operator<<(QDebug d, const McpProtocol::McpProtocolNotificationParams &t);
