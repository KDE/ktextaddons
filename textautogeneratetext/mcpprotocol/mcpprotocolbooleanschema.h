...
{
class TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT McpProtocolBooleanSchema
{
public:
    /*!
     */
...
TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT QDebug operator<<(QDebug d, const McpProtocol::McpProtocolBooleanSchema &t);
