...
{
class TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT McpProtocolTextResourceContents
{
public:
    /*!
     */
...
TEXTAUTOGENERATETEXTMCPPROTOCOL_EXPORT QDebug operator<<(QDebug d, const McpProtocol::McpProtocolTextResourceContents &t);
