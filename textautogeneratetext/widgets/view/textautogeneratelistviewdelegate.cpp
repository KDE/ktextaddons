...
void TextAutogenerateListViewDelegate::drawDateAndIcons(QPainter *painter, const QModelIndex &index, const QStyleOptionViewItem &option) const
{
    ...
    */
    ...
    const QRect dateTextRect = QStyle::alignedRect(Qt::LayoutDirectionAuto, Qt::AlignCenter, layout.dateSize, dateAreaRect);
...
QSize TextAutogenerateListViewDelegate::sizeHint(const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    ...
    const QSize size = {layout.decoRect.width(), layout.decoRect.height() + additionalHeight + layout.dateSize.height()};
    if (!size.isEmpty()) {
...
TextAutogenerateListViewDelegate::MessageLayout TextAutogenerateListViewDelegate::doLayout(const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    ...
    int positionIcon = layout.decoRect.right();
    if (isUser) {
        layout.removeIconRect = QRect(positionIcon, usableRect.bottom(), iconSize, iconSize);
        positionIcon -= iconSize /*- spacing*/;
        layout.editedIconRect = QRect(positionIcon, usableRect.bottom(), iconSize, iconSize);
        positionIcon -= iconSize /*- spacing*/;
    }
    layout.copyIconRect = QRect(positionIcon, usableRect.bottom(), iconSize, iconSize);
