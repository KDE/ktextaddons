...
bool TextAutoGenerateDelegateUtils::generateToolTip(const QTextDocument *doc, const QPoint &pos, QString &formattedTooltip)
{
    ...
    if (href.startsWith(TextUtils::TextUtilsSyntaxHighlighter::insertBlockTextHref())) {
        formattedTooltip = i18nc("@info:tooltip", "Insert Text");
        return true;
    }
                                                                                       ...
                                                                                       const QStyleOptionViewItem &option)
{
    ...
    if (const QTextCursor selectionTextCursor = selection->selectionForIndex(index, doc); !selectionTextCursor.isNull()) {
