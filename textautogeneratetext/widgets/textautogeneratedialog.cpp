    ...
    , mTextAutoGenerateWidget(new TextAutoGenerateStackWidget(mTextAutoGenerateManager, this))
{
    ...
    TextAddonsWidgets::LoadDialogSizeUtils::manageDialogSize(this, QLatin1StringView(myTextAutoGenerateDialogGroupName), QSize(400, 300));
}

TextAutoGenerateDialog::~TextAutoGenerateDialog() = default;
