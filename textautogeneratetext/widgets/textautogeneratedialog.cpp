...
void TextAutoGenerateDialog::readConfig()
{
    ...
    TextAddonsWidgets::LoadDialogSizeUtils::loadDialogSizeScaled(this, QLatin1StringView(myTextAutoGenerateDialogGroupName), 400, 300);
}

void TextAutoGenerateDialog::writeConfig()
{
    TextAddonsWidgets::LoadDialogSizeUtils::saveDialogSize(this, QLatin1StringView(myTextAutoGenerateDialogGroupName));
}
