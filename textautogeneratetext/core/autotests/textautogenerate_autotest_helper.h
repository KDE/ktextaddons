...
{
    const QString refFile = QLatin1StringView(TEXTAUTOGENERATE_DATA_DIR) + repo + name + u".ref"_s;
    const QString generatedFile = QLatin1StringView(TEXTAUTOGENERATE_BINARY_DATA_DIR) + repo + name + u"-generated.ref"_s;
    QDir().mkpath(QLatin1StringView(TEXTAUTOGENERATE_BINARY_DATA_DIR) + repo + name);
