...
{
/*!
 * \class TextAutoGenerateText::TextAutoGenerateTextMcpServerModel
 * \brief The TextAutoGenerateTextMcpServerModel class
 * \author Laurent Montel <montel@kde.org>
 * \inmodule TextAutoGenerateText
 * \inheaderfile TextAutoGenerateText/TextAutoGenerateTextMcpServerModel
 */
class TEXTAUTOGENERATETEXT_EXPORT TextAutoGenerateTextMcpServerModel : public QAbstractListModel
{
    Q_OBJECT
public:
     ...
     */
    explicit TextAutoGenerateTextMcpServerModel(QObject *parent = nullptr);
    /*!
     * Destroys the TextAutoGenerateTextMcpServerModel object.
     */
    ~TextAutoGenerateTextMcpServerModel() override;
