...
class LMStudioModelInstalledInfosDelegate : public TextAutoGenerateText::TextAutoGenerateListViewBaseDelegate
{
    Q_OBJECT
public:
    explicit LMStudioModelInstalledInfosDelegate(QListView *view);
    ~LMStudioModelInstalledInfosDelegate() override;
...
private:
    ...
    [[nodiscard]] LMStudioModelInstalledInfosDelegate::ModelInfoLayout doLayout(const QStyleOptionViewItem &option, const QModelIndex &index) const;
