...
void OllamaModelInstalledInfosDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    painter->save();
    ...
    const OllamaModelInstalledInfosDelegate::ModelInfoLayout layout = doLayout(option, index);
...
void OllamaModelInstalledInfosDelegate::drawCatergories(QPainter *painter,
...
void OllamaModelInstalledInfosDelegate::draw(QPainter *painter,
                                             const OllamaModelInstalledInfosDelegate::ModelInfoLayout &layout,
                                             const QModelIndex &index,
                                             const QStyleOptionViewItem &option) const
{
...
bool OllamaModelInstalledInfosDelegate::mouseEvent(QEvent *event, const QStyleOptionViewItem &option, const QModelIndex &index)
{
...
OllamaModelInstalledInfosDelegate::ModelInfoLayout OllamaModelInstalledInfosDelegate::doLayout(const QStyleOptionViewItem &option,
