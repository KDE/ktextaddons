...
class GenericNetworkModelAvailableInfosDelegate : public TextAutoGenerateText::TextAutoGenerateListViewBaseDelegate
{
    Q_OBJECT
public:
    explicit GenericNetworkModelAvailableInfosDelegate(QListView *view);
    ~GenericNetworkModelAvailableInfosDelegate() override;
...
private:
    ...
    [[nodiscard]] GenericNetworkModelAvailableInfosDelegate::ModelInfoLayout doLayout(const QStyleOptionViewItem &option, const QModelIndex &index) const;
