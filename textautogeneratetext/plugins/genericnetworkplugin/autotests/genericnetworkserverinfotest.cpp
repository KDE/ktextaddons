...
void GenericNetworkServerInfoTest::shouldConvertPluginNetworkTypeFromString()
{
    ...
    QCOMPARE(info.pluginNetworkTypeFromString(u"gorkai"_s), GenericNetworkManager::PluginNetworkType::GorkAI);
}
...
void GenericNetworkServerInfoTest::shouldCheckApiUrl()
{
    ...
    QCOMPARE(info.apiUrl(GenericNetworkManager::PluginNetworkType::GorkAI), u"https://api.x.ai/v1/"_s);
}
...
void GenericNetworkServerInfoTest::shouldChatCompletionPath()
{
    ...
    QCOMPARE(info.chatCompletionPath(GenericNetworkManager::PluginNetworkType::GorkAI), u"chat/completions"_s);
}
...
void GenericNetworkServerInfoTest::shouldDefinePluginName()
{
    ...
    QCOMPARE(info.pluginName(GenericNetworkManager::PluginNetworkType::GorkAI), u"gorkai"_s);
}
...
void GenericNetworkServerInfoTest::shouldDefineLimitations()
{
    ...
    QCOMPARE(info.limitations(GenericNetworkManager::PluginNetworkType::GorkAI), GenericNetworkServerInfo::Limitation::None);
}
