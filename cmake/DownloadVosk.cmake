...
function(download_vosk_if_needed)
    ...
    if(${CMAKE_SYSTEM_NAME} MATCHES "Linux" OR ANDROID)
        ...
        elseif(${CMAKE_SYSTEM_PROCESSOR} MATCHES "riscv64")
            set(VOSK_URL
                "https://github.com/alphacep/vosk-api/releases/download/v0.3.45/vosk-linux-riscv64-0.3.45.zip"
            )
    ...
    elseif(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
        if(${CMAKE_SIZEOF_VOID_P} MATCHES "4")
            set(VOSK_URL
                "https://github.com/alphacep/vosk-api/releases/download/v0.3.42/vosk-win32-0.3.42.zip"
            )
    ...
    execute_process(
        COMMAND ${CMAKE_COMMAND} -E tar xf "${VOSK_ZIP}"
        WORKING_DIRECTORY "${CMAKE_BINARY_DIR}/tempDir"
    )
